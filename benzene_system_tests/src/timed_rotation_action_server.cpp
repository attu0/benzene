 ...
 *
 * Action Server:
 *   timed_rotation (benzene_msgs/action/TimedRotation):
...
#include "benzene_msgs/action/timed_rotation.hpp"
#include "geometry_msgs/msg/twist_stamped.hpp"

using namespace std::chrono_literals;
using TimedRotation = benzene_msgs::action::TimedRotation;
...
private:
  ...
  void execute(const std::shared_ptr<GoalHandleTimedRotation> goal_handle)
  {
    ...
    twist_stamped_msg.header.frame_id = "base_footprint";  // Set the reference frame
