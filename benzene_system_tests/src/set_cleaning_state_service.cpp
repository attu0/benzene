 ...
 *
 * Services:
 *   /set_cleaning_state (benzene_msgs/srv/SetCleaningState):
...
#include "benzene_msgs/srv/set_cleaning_state.hpp"
...
public:
  ...
  {
    service_ = this->create_service<benzene_msgs::srv::SetCleaningState>(
      "/set_cleaning_state",
...
private:
  ...
  void set_cleaning_state_callback(
    const std::shared_ptr<benzene_msgs::srv::SetCleaningState::Request> request,
    std::shared_ptr<benzene_msgs::srv::SetCleaningState::Response> response)
  {
  ...
  rclcpp::Service<benzene_msgs::srv::SetCleaningState>::SharedPtr service_;
};
