...
def process_ros2_controllers_config(context):
    ...
    src_config_path = os.path.join(
        home,
        'ros2_ws/src/benzene/benzene_description/config',
        robot_name
    )
    install_config_path = os.path.join(
        home,
        'ros2_ws/install/benzene_description/share/benzene_description/config',
        robot_name
    )
...
ARGUMENTS = [
    DeclareLaunchArgument('robot_name', default_value='benzene',
...
def generate_launch_description():
    ...
    """
    # Define filenames
    urdf_package = 'benzene_description'
    urdf_filename = 'benzene.urdf.xacro'
    rviz_config_filename = 'benzene_description.rviz'
